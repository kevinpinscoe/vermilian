...
- [x] **Epic context** — read and display native Epic → Subtask issue links (parent epic, no
      full portfolio management); populated the active-Epic filter Choose next deferred; and
