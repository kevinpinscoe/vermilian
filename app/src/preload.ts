...
const api: VermilianAPI = {
  ...
  getDismissals: () => ipcRenderer.invoke(IPC.getDismissals),
  saveDismissal: (entry: unknown) => ipcRenderer.invoke(IPC.saveDismissal, entry),
  ...
  getMasterPlan: () => ipcRenderer.invoke(IPC.getMasterPlan),
